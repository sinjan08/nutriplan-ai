...
class CartRepositary
{
  ...
  /**
   * delete rows by user_id
   * @param mixed $userId
   * @throws Exception
   * @return array{deleted: bool, user_id: mixed}
   */
  public function deleteByUserId($userId)
  {
    try {
      ...
      $this->client->deleteByField($this->collection, 'user_id', $userId);
      ...
      AppLogger::error("CartRepository@deleteByUserId failed: " . $e->getMessage());
      throw new Exception("Unable to delete cart items: " . $e->getMessage());
    }
  }
}
